  ...
  useEffect(() => {
    const initGrowCST = async () => {
      ...
      const getCST = await axios({
        url: "http://localhost:3005/getCSTGrow",
            ...
            return (
              <>
                <div className="div-Area-Button-Project">
                  ...
                  >
                    <Link className="Link-Underline-Color" to="/growCSTDetail">
                      {data.ID_Stem}
                    </Link>
                  </button>
                </div>
      ...
      <div className="Body-GrowSST">
        ...
        <div className="Head-Farm">
          <div className="div-Head-Left-Side">
            <p className="P-Farm">การเจริญเติบโต ขั้นตอน CST</p>
          </div>
